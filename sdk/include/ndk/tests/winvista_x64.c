...
C_ASSERT_FIELD(KTHREAD, 0x0F8, UCHAR[168], WaitBlockFill7)
C_ASSERT_FIELD(KTHREAD, 0x1A0, PVOID, TebMappedLowVa)
C_ASSERT_FIELD(KTHREAD, 0x1A8, struct _UMS_CONTROL_BLOCK*, Ucb)
