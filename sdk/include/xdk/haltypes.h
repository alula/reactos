...
typedef struct _HAL_ACPI_ROOT_POINTER_INFORMATION {
  PHYSICAL_ADDRESS RsdpPhysicalAddress;
} HAL_ACPI_ROOT_POINTER_INFORMATION, *PHAL_ACPI_ROOT_POINTER_INFORMATION;
