...
function(set_ndis_version target version role)
    ...
    if(version EQUAL 620)
        list(APPEND defs NDIS620 NDIS620_${role})
        set(ntddi 0x06010000)
        set(winnt 0x0601)
    elseif(version EQUAL 61)
        list(APPEND defs NDIS61 NDIS61_${role})
        set(ntddi 0x06000100)
        set(winnt 0x0600)
    elseif(version EQUAL 60)
        list(APPEND defs NDIS60 NDIS60_${role})
        set(ntddi 0x06000000)
        set(winnt 0x0600)
    elseif(version EQUAL 51)
        list(APPEND defs NDIS51 NDIS51_${role})
        set(ntddi 0x05010000)
        set(winnt 0x0501)
    elseif(version EQUAL 50)
        list(APPEND defs NDIS50 NDIS50_${role})
        set(ntddi 0x05000000)
        set(winnt 0x0500)
    else()
    ...
    target_compile_options(${target} PRIVATE
        -UNTDDI_VERSION -DNTDDI_VERSION=${ntddi}
        -U_WIN32_WINNT -D_WIN32_WINNT=${winnt}
        -UWINVER -DWINVER=${winnt})
endfunction()
