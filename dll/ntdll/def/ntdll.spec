...
@ stdcall -arch=arm64 NtAllocateVirtualMemoryEx(long ptr ptr long long ptr long)
...
@ stdcall -arch=arm64 RtlWow64GetCurrentCpuArea(ptr ptr ptr)
@ stdcall -stub -arch=arm64 RtlIsEcCode(ptr)
@ stdcall -arch=arm64 ProcessPendingCrossProcessEmulatorWork()
@ stdcall -arch=arm64 RtlWow64PopAllCrossProcessWorkFromWorkList(ptr ptr)
@ stdcall -arch=arm64 RtlWow64PushCrossProcessWorkOntoFreeList(ptr ptr)
...
@ stdcall -stub -version=0x600+ -arch=x86_64,arm64 RtlWow64GetThreadContext(ptr ptr)
@ stdcall -stub -version=0x600+ -arch=x86_64,arm64 RtlWow64LogMessageInEventLogger(long long long)
@ stdcall -stub -version=0x600+ -arch=x86_64,arm64 RtlWow64SetThreadContext(long long)
@ stdcall -stub -version=0x600+ -arch=x86_64,arm64 RtlWow64SuspendThread(long long)
